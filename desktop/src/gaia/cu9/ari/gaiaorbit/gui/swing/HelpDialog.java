...
public class HelpDialog extends I18nJFrame {
    ...
    public HelpDialog() {
	super(txt("gui.help.help") + " - " + GlobalConf.APPLICATION_NAME + " v" + GlobalConf.inst.VERSION.version);
	initialize();
	frame.pack();
	...
	aux.setFont(boldFont);
	build.add(aux);
	build.add(new JLabel(GlobalConf.inst.VERSION.version), "wrap");
	aux = new JLabel(txt("gui.help.buildnumber"));
	aux.setFont(boldFont);
	build.add(aux);
	build.add(new JLabel(GlobalConf.inst.VERSION.build), "wrap");
	aux = new JLabel(txt("gui.help.buildtime"));
	aux.setFont(boldFont);
	build.add(aux);
	build.add(new JLabel(GlobalConf.inst.VERSION.buildtime), "wrap");
	aux = new JLabel(txt("gui.help.buildsys"));
	aux.setFont(boldFont);
	build.add(aux);

	JTextArea versionsystem = new JTextArea(GlobalConf.inst.VERSION.system);
	...
	aux.setFont(boldFont);
	build.add(aux);
	build.add(new JLabel(GlobalConf.inst.VERSION.builder), "wrap");
	...
	JTextArea intro = new JTextArea(txt("gui.help.gscredits", GlobalConf.inst.VERSION.version));
