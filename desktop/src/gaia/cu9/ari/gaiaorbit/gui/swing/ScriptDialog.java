...
public class ScriptDialog extends I18nJFrame {
	...
	scriptChooser.getWebFileChooser().setCurrentDirectory(new File(GlobalConf.instance.SCRIPT_LOCATION));
	...
	okButton.addActionListener(new ActionListener() {
		...
		if (code != null) {
		    EventManager.getInstance().post(Events.RUN_SCRIPT_PYCODE, code, GlobalConf.instance.SCRIPT_LOCATION, async);
		}
	    }
	});
