...
public class GaiaSandboxGuiSwing extends JFrame {
	...
	try {
	    ...
	    sg = SceneGraphLoader.loadSceneGraph(new FileInputStream(new File(assetsLocation + GlobalConf.data.DATA_SG_FILE)), GlobalClock.clock, GlobalConf.performance.MULTITHREADING, GlobalConf.performance.NUMBER_THREADS, !GlobalConf.data.DATA_SOURCE_LOCAL);
