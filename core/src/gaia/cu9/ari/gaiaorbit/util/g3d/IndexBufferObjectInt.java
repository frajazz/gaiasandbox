...
/**
 * <p>
 * Copy of libgdx's IndexBufferObject class using integers instead of shorts for indices.
 * </p>
 * <p>
...
public class IndexBufferObjectInt implements IndexDataInt {
    IntBuffer buffer;
    ...
    public IndexBufferObjectInt(int maxIndices) {
     ...
     * @param maxIndices the maximum number of indices this buffer can hold */
    public IndexBufferObjectInt(boolean isStatic, int maxIndices) {
