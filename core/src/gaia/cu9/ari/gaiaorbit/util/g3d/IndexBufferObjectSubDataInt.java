...
/**
 * <p>
 * Copy of libgdx's IndexBufferObjectSubData class using integers instead of shorts for indices.
 * </p>
 * <p>
 ...
 * 
 * @author mzechner */
public class IndexBufferObjectSubDataInt implements IndexDataInt {
	IntBuffer buffer;
	...
	public IndexBufferObjectSubDataInt(boolean isStatic, int maxIndices) {
	 ...
	 * 
	 * @param maxIndices the maximum number of indices this buffer can hold */
	public IndexBufferObjectSubDataInt(int maxIndices) {
		byteBuffer = BufferUtils.newByteBuffer(maxIndices * 2);
		this.isDirect = true;
