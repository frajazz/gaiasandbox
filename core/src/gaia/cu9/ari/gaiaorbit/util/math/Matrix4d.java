...
public class Matrix4d implements Serializable {
     ...
     * Vector3d multiplication this value is multiplied with the source X component and added to the target X component. */
    public static final int M00 = 0;
    /** XY: Typically the negative sine of the angle when rotated on the Z axis. On Vector3d multiplication this value is multiplied
     * with the source Y component and added to the target X component. */
    public static final int M01 = 4;
    /** XZ: Typically the sine of the angle when rotated on the Y axis. On Vector3d multiplication this value is multiplied with the
    ...
    /** YX: Typically the sine of the angle when rotated on the Z axis. On Vector3d multiplication this value is multiplied with the
     ...
     * Vector3d multiplication this value is multiplied with the source Y component and added to the target Y component. */
    public static final int M11 = 5;
    /** YZ: Typically the negative sine of the angle when rotated on the X axis. On Vector3d multiplication this value is multiplied
    ...
    /** ZX: Typically the negative sine of the angle when rotated on the Y axis. On Vector3d multiplication this value is multiplied
     * with the source X component and added to the target Z component. */
    public static final int M20 = 2;
    /** ZY: Typical the sine of the angle when rotated on the X axis. On Vector3d multiplication this value is multiplied with the
     ...
     * Vector3d multiplication this value is multiplied with the source Z component and added to the target Z component. */
    ...
    public float[] valuesf() {
        float[] aux = new float[val.length];
        for (int i = 0; i < val.length; i++) {
            aux[i] = (float) val[i];
        }
        return aux;
    ...
    public double getScaleX() {
        return (MathUtilsd.isZero(val[Matrix4d.M01]) && MathUtilsd.isZero(val[Matrix4d.M02])) ? val[Matrix4d.M00] : (double) Math
                .sqrt(getScaleXSquared());
    }

    /** @return the scale factor on the Y axis (non-negative) */
    public double getScaleY() {
        return (MathUtilsd.isZero(val[Matrix4d.M10]) && MathUtilsd.isZero(val[Matrix4d.M12])) ? val[Matrix4d.M11] : (double) Math
                .sqrt(getScaleYSquared());
    }

    /** @return the scale factor on the X axis (non-negative) */
    public double getScaleZ() {
        return (MathUtilsd.isZero(val[Matrix4d.M20]) && MathUtilsd.isZero(val[Matrix4d.M21])) ? val[Matrix4d.M22] : (double) Math
