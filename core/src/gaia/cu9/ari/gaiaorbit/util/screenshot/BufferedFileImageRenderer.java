...
public class BufferedFileImageRenderer implements IFileImageRenderer {
	...
	synchronized (outputFrameBuffer) {
	    ...
	    if (size > 0) {
		// Notify
		EventManager.instance.post(Events.POST_NOTIFICATION, I18n.bundle.get("notif.flushframebuffer"));
		...
		TimerTask tt = new TimerTask() {
			...
			EventManager.instance.post(Events.POST_NOTIFICATION, I18n.bundle.format("notif.flushframebuffer.finished", size, folder));
		    }
		};
		timer.schedule(tt, 0);
	    }
