...
public class Link extends Label {
	...
	public Link(CharSequence text, Skin skin, String fontName, Color color,
			String linkto) {
	...
	public Link(CharSequence text, Skin skin, String fontName,
			String colorName, String linkto) {
		...
		this.addListener(new EventListener() {
			...
			public boolean handle(Event event) {
				if (event instanceof InputEvent) {
					...
					// Click
					if (type == Type.touchUp
							&& ((InputEvent) event).getButton() == Buttons.LEFT) {
