...
public class GaiaSandbox implements ApplicationListener, IObserver {
    ...
    private static String FILE_JSON = "data/extra.json data/planets.json data/moons.json data/orbits.json"; /*"data/planets.json data/moons.json data/satellites.json data/asteroids.json data/orbits.json data/extra.json data/locations.json data/earth_locations.json data/moon_locations.json";*/
